...
const Registration: React.FC = () => {
    ...
    return (
        <Authentication title={"Registration"} handleSubmit={handleRegistration} buttonText={'register'} linkPath={'/login'} linkText={`If you have an account you may`} linkBoldText={'Login'} name='register' role='button'>
